    ...
    public static void main(String[] args) {
        ...
        switch(pilihan){
            ...
            switch (kodepegawai) {
                ...
                System.out.println("Tanggal Pinjam     : "+tglpinjam.format(DateTimeFormatter.ofPattern("dd-MMMM-yyyy")));
                System.out.println("Batas Pengembalian : "+btskembali.format(DateTimeFormatter.ofPattern("dd-MMMM-yyyy")));
                System.out.println("Catatan 'Jika Anda Melebihi Batas Tanggal Kembali'\nAkan dikenakan DENDA sebesar Rp.500 per Harinya!");
                System.out.println("");                
            ...
            switch (kodepegawai) {
                ...
                System.out.println("Penerbit           : "+penerbit);
                System.out.println("Jumlah Halaman     : "+halaman+" Halaman");
                System.out.println("Tanggal Pinjam     : "+tglpeminjaman.format(DateTimeFormatter.ofPattern("dd-MMMM-yyyy")));
                System.out.println("Batas Pengembalian : "+btspengembalian.format(DateTimeFormatter.ofPattern("dd-MMMM-yyyy")));
                System.out.println("----------------------");
                ...
                if(tglpengembalian.getDayOfYear()>btspengembalian.getDayOfYear()){
                int haritelat = telat.getDayOfYear();
        ...
        System.out.println("Apakah Anda ingin Meminjam Lagi? Atau ingin Mengembalikan (Y/T)");
        pinjam = in.next();
        }
